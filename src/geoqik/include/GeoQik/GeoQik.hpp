 ...
 */
GEOQIK_EXPORT geoqik_result_t geoqik_init();
...
GEOQIK_EXPORT geoqik_result_t geoqik_get_point_size(float* pointSize);
...
GEOQIK_EXPORT geoqik_result_t geoqik_set_line_width(float lineWidth);
GEOQIK_EXPORT geoqik_result_t geoqik_get_line_width(float* lineWidth);
 ...
 */
GEOQIK_EXPORT geoqik_result_t geoqik_draw();
GEOQIK_EXPORT geoqik_result_t geoqik_stop_drawing();
 ...
 */
GEOQIK_EXPORT geoqik_result_t geoqik_wait_for_exit_and_cleanup();
 ...
 */
GEOQIK_EXPORT geoqik_result_t geoqik_cleanup();
