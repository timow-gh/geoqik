...
constexpr float defaultMeshFillLightDirectionZ = 0.6F;
constexpr float defaultMeshFillLightColorRed = 0.25F;
constexpr float defaultMeshFillLightColorGreen = 0.28F;
constexpr float defaultMeshFillLightColorBlue = 0.35F;
constexpr float defaultMeshFillLightIntensity = 1.0F;
...
static geoqik_settings_t create_default_c_settings() {
    ...
    settings.meshFillLightColor[2] = defaultMeshFillLightColorBlue;
