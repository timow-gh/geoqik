...
[[nodiscard]] ReplayUndoFrame make_replay_undo_frame(const AddPointsWithOpts& message,
                                                     const ReplayUndoContext& context);
[[nodiscard]] ReplayUndoFrame make_replay_undo_frame(const UpdatePointWithOpts& message,
                                                     const ReplayUndoContext& context);
[[nodiscard]] ReplayUndoFrame make_replay_undo_frame(const UpdatePointsWithOpts& message,
                                                     const ReplayUndoContext& context);
...
[[nodiscard]] ReplayUndoFrame make_replay_undo_frame(const UpdateLineWithOpts& message,
                                                     const ReplayUndoContext& context);
[[nodiscard]] ReplayUndoFrame make_replay_undo_frame(const UpdateLinesWithOpts& message,
                                                     const ReplayUndoContext& context);
...
[[nodiscard]] ReplayUndoFrame make_replay_undo_frame(const RemoveAllGeometry& message,
                                                     const ReplayUndoContext& context);
...
[[nodiscard]] ReplayUndoFrame make_replay_undo_frame(const UpdateMeshWithOpts& message,
                                                     const ReplayUndoContext& context);
[[nodiscard]] ReplayUndoFrame make_replay_undo_frame(const SetMeshOverlayOpts& message,
                                                     const ReplayUndoContext& context);
[[nodiscard]] ReplayUndoFrame make_replay_undo_frame(const SetMeshRenderingOpts& message,
                                                     const ReplayUndoContext& context);
