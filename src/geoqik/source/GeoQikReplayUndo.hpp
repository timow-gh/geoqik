...
struct ReplayUndoContext {
    ...
    [[nodiscard]]
    bool has_known_idempotency_key(const core::UUID& key) const;
};
...
[[nodiscard]]
ReplayUndoFrame make_replay_undo_frame(const SetPointSize& message, const ReplayUndoContext& context);
[[nodiscard]]
ReplayUndoFrame make_replay_undo_frame(const SetPointColor& message, const ReplayUndoContext& context);
[[nodiscard]]
...
[[nodiscard]]
ReplayUndoFrame make_replay_undo_frame(const SetLineWidth& message, const ReplayUndoContext& context);
[[nodiscard]]
ReplayUndoFrame make_replay_undo_frame(const SetLineColor& message, const ReplayUndoContext& context);
[[nodiscard]]
ReplayUndoFrame make_replay_undo_frame(const SetMeshColor& message, const ReplayUndoContext& context);
[[nodiscard]]
ReplayUndoFrame make_replay_undo_frame(const RemoveAllGeometry& message, const ReplayUndoContext& context);
[[nodiscard]]
...
[[nodiscard]]
ReplayUndoFrame make_replay_undo_frame(const RemoveMesh& message, const ReplayUndoContext& context);
[[nodiscard]]
ReplayUndoFrame make_replay_undo_frame(const UpdateMeshWithOpts& message, const ReplayUndoContext& context);
[[nodiscard]]
ReplayUndoFrame make_replay_undo_frame(const SetMeshOverlayOpts& message, const ReplayUndoContext& context);
[[nodiscard]]
ReplayUndoFrame make_replay_undo_frame(const SetMeshRenderingOpts& message, const ReplayUndoContext& context);
