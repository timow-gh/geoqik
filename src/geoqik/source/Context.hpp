...
class Context {
  ...
  public:
    ...
    void
    update_points_with_opts(const core::UUID& handle, std::span<const float> points, std::span<const float> colors);
    ...
    void add_line(float x1,
                  ...
                  const core::UUID* idempotencyKey = nullptr);
    void add_line(float x1,
                  float y1,
                  float z1,
                  float x2,
                  ...
                  const core::UUID* handle = nullptr,
                  const core::UUID* idempotencyKey = nullptr);
    void add_line_with_opts(float x1,
                            float y1,
                            float z1,
                            float x2,
                            float y2,
