...
public:
  ...
  [[nodiscard]] constexpr Location get_projection_matrix_location() const noexcept { return m_input.m_projectionMatrix.get_location(); }
  [[nodiscard]] constexpr Location get_normal_matrix_location() const noexcept { return m_input.m_normalMatrix.get_location(); }
  [[nodiscard]] constexpr Location get_pos_location() const noexcept { return m_input.m_posLocation.get_location(); }
  [[nodiscard]] constexpr Location get_color_location() const noexcept { return m_input.m_colorLocation.get_location(); }
  [[nodiscard]] constexpr Location get_normal_location() const noexcept { return m_input.m_normalLocation.get_location(); }
