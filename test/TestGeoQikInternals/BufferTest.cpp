...
struct UserType {
  ...
  UserType() : data(std::make_unique<int>(0)) {}
  UserType(int value) : data(std::make_unique<int>(value)) {}
  UserType(const UserType& other) : data(std::make_unique<int>(*other.data)) {}
  UserType(UserType&& other) noexcept : data(std::move(other.data)) {}
