                                                                  ...
                                                                  const std::vector<float>& colors)
{
  ...
  return manager.add_mesh_drawable(vertices,
                                   3,
                                   normals,
                                   colors,
                                   4,
...
TEST(DrawableTransparencyInfoTest, HandlesEdgeCasesAndSortableCollections)
{
  ...
  const std::vector<std::uint32_t> flatLines = opengl::flatten_translucent_line_indices(lineSplit.translucentSegments);
...
TEST_F(OpenGLDrawableTest, DrawablesManagerUpdatesClearsAndDrawsTransparentPointsAndLines)
{
  ...
  const std::vector<std::uint32_t> emptyIndices;
  manager.update_last_point_drawable(emptyFloatData, emptyFloatData, emptyIndices, opengl::BufferAccessPattern::DYNAMIC_DRAW);
  manager.update_last_line_drawable(emptyFloatData, emptyFloatData, emptyIndices, opengl::BufferAccessPattern::DYNAMIC_DRAW);
  ...
  const opengl::DrawablesManager::DrawableId firstPointId =
      manager.add_point_drawable(pointVertices, 3, pointColors, 4, pointIndices, 3.0F, opengl::BufferAccessPattern::STATIC_DRAW);
  ...
  manager.update_last_point_drawable(pointVertices, pointColors, emptyIndices, opengl::BufferAccessPattern::DYNAMIC_DRAW);
  manager.update_last_line_drawable(lineVertices, lineColors, emptyIndices, opengl::BufferAccessPattern::DYNAMIC_DRAW);
