...
main()
{
    ...
    auto r1 = geoqik_add_mesh_opts(cubeVertices, cubeVertexCount, cubeTriangles, cubeTriangleCount, nullptr);
    ...
    auto r2 = geoqik_add_mesh_opts(cubeVertices, cubeVertexCount, cubeTriangles, cubeTriangleCount, &meshOpts);
